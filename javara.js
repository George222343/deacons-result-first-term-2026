...
const nah = document.getElementById("nahda")
const fnah = document.getElementById("finalnahda")
fetch("./term.json")
  ...
  .then((data) => {
    ...
    nam9.innerText = student.totalPresent;
     if (student.nahda === -1) {
      naaa.style = "display: none;";
    } else {
      naaa.style = "display: block;";
    }
    nah.innerText = student.nahda
    fnah.innerText = student.finalnahda
